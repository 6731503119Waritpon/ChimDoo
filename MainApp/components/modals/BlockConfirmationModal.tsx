...
import { BlockConfirmationModalProps } from '@/types/modals';

export default function BlockConfirmationModal({ visible, onClose, onConfirm, userName, loading }: BlockConfirmationModalProps) {
    return (
        <Modal
            visible={visible}
            transparent
            ...
            <View style={styles.overlay}>
                ...
                <View style={styles.modalView}>
                    <View style={styles.iconContainer}>
                        <UserX size={32} color={AppColors.primary} />
                    </View>
                    
                    <Text style={styles.title}>Block User</Text>
                    
                    <Text style={styles.message}>
                        Are you sure you want to block <Text style={styles.boldText}>{userName}</Text>?
