    ...
    useEffect(() => {
        const initChat = async () => {
            try {
                ...
                let initMessageText = 'กำลังโหลดข้อความต้อนรับ...';
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            const errorMsg: Message = {
                ...
                text: `เกิดข้อผิดพลาด: ${error.message} ${apiKeyPreview}`,
                isUser: false,
            };
            ...
            >
                ...
                {initializing ? (
                    <View style={styles.loadingContainer}>
                        ...
                        <Text style={styles.loadingText}>กำลังตระเตรียมเครื่องครัว...</Text>
                    </View>
                ) : (
                    <>
                        <FlatList
